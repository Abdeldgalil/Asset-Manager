 ...
 */
export const generateStory = async (storyInput: StoryInput, options?: RequestInit): Promise<StoryResult> => {

  return customFetch<StoryResult>(getGenerateStoryUrl(),
  {
    ...options,
    method: 'POST',
...
export const getGenerateStoryMutationOptions = <TError = ErrorType<ApiError>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateStoryMutationError = ErrorType<ApiError>

    /**
 * @summary Generate an AI story for a child
 */
export const useGenerateStory = <TError = ErrorType<ApiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateStory>>, TError,{data: BodyType<StoryInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
